document.addEventListener('DOMContentLoaded', function() {
    ...
    const amharicToEnglishMap = {
        'ሀ': 'ha', 'ሁ': 'hu', 'ሂ': 'hi', 'ሃ': 'ha', 'ሄ': 'hie', 'ህ': 'h', 'ሆ': 'ho',
